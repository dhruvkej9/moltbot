...
const BUNDLED_WEB_SEARCH_PROVIDER_DESCRIPTORS = [
  ...
  },
  {
    ...
    inactiveSecretPaths: ["plugins.entries.duckduckgo.config.webSearch.apiKey"],
    credentialScope: { kind: "none" },
...
function buildBundledWebSearchProviderEntry(
  ...
  const noCredential = descriptor.credentialScope.kind === "none";
  return {
    ...
    getConfiguredCredentialValue:
      noCredential || descriptor.supportsConfiguredCredentialValue === false
        ? undefined
